 ...
 * Size: 18 px
 * Bpp: 4
 * Opts: --bpp 4 --size 18 --font D:\projects\SquareLine_Projects\Hello_Watch\DateDaySet_Page\assets\方正粗圆简体.TTF -o D:\projects\SquareLine_Projects\Hello_Watch\DateDaySet_Page\assets\ui_font_Cuyuan18.c --format lvgl --symbols 改写选择开发中今日步数 --no-compress --no-prefilter
 ******************************************************************************/
