 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --bpp 4 --size 16 --font D:\HelloWatch_GUI\assets\iconfont.ttf -o D:\HelloWatch_GUI\assets\ui_font_iconfont16.c --format lvgl -r 0xe68f --no-compress --no-prefilter
 ******************************************************************************/
