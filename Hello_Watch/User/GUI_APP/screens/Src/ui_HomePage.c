...
uint8_t ui_HomePageTempValue = 25;
uint8_t ui_HomePageHumiValue = 67;

//Enable
int8_t ui_HomePageBLEEN = 0;
int8_t ui_HomePageNFCEN = 0;


///////////////////// Page Manager //////////////////
Page_t Page_Home = {ui_HomePage_screen_init, ui_HomePage_screen_deinit, &ui_HomePage};
Page_t Page_Power = {ui_PowerPage_screen_init, ui_PowerPage_screen_deinit, &ui_PagePower};


static void HomePage_timer_cb(lv_timer_t *timer)
{
    int8_t value_strbuf[10];
...
void ui_HomePage_screen_init(void)
{
    ...
    lv_obj_set_x(ui_StepCnLabel, -55);
    ...
    lv_obj_set_height(ui_HRArc, 47);
    lv_obj_set_x(ui_HRArc, 77);
    lv_obj_set_y(ui_HRArc, 82);
    lv_obj_set_align(ui_HRArc, LV_ALIGN_CENTER);
    lv_arc_set_range(ui_HRArc, 100, 100);
    lv_arc_set_bg_angles(ui_HRArc, 135, 134);
    lv_obj_set_style_border_width(ui_HRArc, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_arc_width(ui_HRArc, 5, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_arc_color(ui_HRArc, lv_color_hex(0xC40909), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_HRArc, lv_color_hex(0xFFFFFF), LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_HRArc, 0, LV_PART_KNOB | LV_STATE_DEFAULT);

    ui_HRiconLabel = lv_label_create(ui_HRArc);
    ...
    lv_obj_set_style_text_color(ui_HRiconLabel, lv_color_hex(0xC40909), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_HRiconLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_HRiconLabel, &ui_font_iconfont33, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BatArc = lv_arc_create(ui_HomePage);
    lv_obj_set_width(ui_BatArc, 44);
    lv_obj_set_height(ui_BatArc, 51);
    lv_obj_set_x(ui_BatArc, -79);
    lv_obj_set_y(ui_BatArc, -71);
    lv_obj_set_align(ui_BatArc, LV_ALIGN_CENTER);
    lv_obj_set_style_border_width(ui_BatArc, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_color(ui_BatArc, lv_color_hex(0x40FF62), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_BatArc, lv_color_hex(0xFFFFFF), LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_BaticonLabel, -1);
    lv_obj_set_y(ui_BaticonLabel, 16);
    lv_obj_set_align(ui_BaticonLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_BaticonLabel, "");
    lv_obj_set_style_text_color(ui_BaticonLabel, lv_color_hex(0x0AF02A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_BatNumLabel = lv_label_create(ui_BatArc);
    ...
    lv_obj_set_height(ui_HumiArc, 47);
    lv_obj_set_x(ui_HumiArc, 1);
    lv_obj_set_y(ui_HumiArc, 82);
    lv_obj_set_align(ui_HumiArc, LV_ALIGN_CENTER);
    lv_arc_set_value(ui_HumiArc, 80);
    lv_arc_set_bg_angles(ui_HumiArc, 270, 269);
    lv_obj_set_style_arc_width(ui_HumiArc, 5, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_arc_color(ui_HumiArc, lv_color_hex(0x40CDFF), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui_HumiArc, 0, LV_PART_KNOB | LV_STATE_DEFAULT);

    ui_HumiiconLabel = lv_label_create(ui_HumiArc);
    ...
    lv_obj_set_style_text_color(ui_HumiiconLabel, lv_color_hex(0x40CDFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_HumiiconLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_HumiiconLabel, &ui_font_iconfont29, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_TempArc = lv_arc_create(ui_HomePage);
    lv_obj_set_width(ui_TempArc, 47);
    lv_obj_set_height(ui_TempArc, 47);
    lv_obj_set_x(ui_TempArc, -76);
    lv_obj_set_y(ui_TempArc, 82);
    lv_obj_set_align(ui_TempArc, LV_ALIGN_CENTER);
    lv_arc_set_range(ui_TempArc, 0, 50);
    lv_arc_set_value(ui_TempArc, 26);
    lv_obj_set_style_arc_width(ui_TempArc, 5, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_arc_color(ui_TempArc, lv_color_hex(0xF79C1D), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_TempiconLabel, 2);
    lv_obj_set_y(ui_TempiconLabel, 1);
    lv_obj_set_align(ui_TempiconLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_TempiconLabel, "");
    lv_obj_set_style_text_color(ui_TempiconLabel, lv_color_hex(0xF79C1D), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_TempiconLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_TempiconLabel, &ui_font_iconfont31, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_StepiconLabel, -99);
    lv_obj_set_y(ui_StepiconLabel, -10);
    lv_obj_set_align(ui_StepiconLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_StepiconLabel, "");
    lv_obj_set_style_text_color(ui_StepiconLabel, lv_color_hex(0x3656FC), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_StepiconLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_StepiconLabel, &ui_font_iconfont25, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_StepNumBar = lv_bar_create(ui_HomePage);
    lv_bar_set_range(ui_StepNumBar, 0, 30000);
    lv_bar_set_value(ui_StepNumBar, 20000, LV_ANIM_OFF);
    lv_obj_set_width(ui_StepNumBar, 200);
    lv_obj_set_height(ui_StepNumBar, 10);
    lv_obj_set_x(ui_StepNumBar, 3);
    lv_obj_set_y(ui_StepNumBar, 39);
    lv_obj_set_align(ui_StepNumBar, LV_ALIGN_CENTER);

    lv_obj_set_style_bg_color(ui_StepNumBar, lv_color_hex(0x3656FC), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_TimeColonLabel, 41);
    lv_obj_set_y(ui_TimeColonLabel, -72);
    ...
    lv_obj_set_style_bg_color(ui_DropDownPanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_DropDownPanel, lv_color_hex(0x000000), LV_PART_SCROLLBAR | LV_STATE_SCROLLED);
    ...
    lv_obj_set_style_text_font(ui_NFCLabel, &ui_font_fonticonfont34, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_BLELabel, &ui_font_fonticonfont34, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_PowerLabel, &ui_font_fonticonfont34, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_flag(ui_SetButton, LV_OBJ_FLAG_CHECKABLE | LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    ...
    lv_obj_set_style_text_font(ui_SetLabel, &ui_font_fonticonfont34, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_LightLabel, &ui_font_fonticonfont34, LV_PART_MAIN | LV_STATE_DEFAULT);
