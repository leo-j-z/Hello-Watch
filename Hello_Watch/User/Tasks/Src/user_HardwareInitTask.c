...
void HardwareInitTask(void *argument)
{
    ...
    sprintf(lcd_buf_str, "HELLO-Watch V%d.%d.%d", watch_version_major(), watch_version_minor(), watch_version_patch());
    LCD_ShowString(20, LCD_H/2+48, (uint8_t*)lcd_buf_str, WHITE, BLACK, 24, 0);
    delay_ms(1000);
